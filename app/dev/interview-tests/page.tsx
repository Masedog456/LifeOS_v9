"use client";
/** Life Architecture Interview self-tests (LIFEOS-058). Dev-only surface. */
import { useMemo } from "react";
import { runInterviewSelfTests } from "@/lib/interview/selftest";

export default function InterviewTestsPage() {
  // Pure and synchronous — no effect, no state, no cascading render.
  const report = useMemo(() => runInterviewSelfTests(), []);
  return (
