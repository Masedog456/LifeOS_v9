...
export const ROUTE_INVENTORY: readonly RouteAudit[] = [
  ...
  { route: "/constitution", surface: "Beliefs", purpose: "Claims with evidence.", primaryAction: "Open belief", secondaryActions: ["Review"], emptyState: "account", loadingState: "skeleton", errorState: "boundary", mobile: "list", keyboard: "arrow nav", inspector: "panel", onboardingDependency: false, notes: [] },
