...
export const ROUTE_INVENTORY: readonly RouteAudit[] = [
  ...
  { route: "/today/decisions", surface: "Needs your decision", purpose: "The judgment calls Conqify will not settle on its own.", primaryAction: "Answer one question", secondaryActions: ["Open the record"], emptyState: "route", loadingState: "skeleton", errorState: "boundary", mobile: "one scroll", keyboard: "tab through", inspector: "n/a", onboardingDependency: false, notes: ["LIFEOS-094: derived, never persisted; open work stays on /today (§17)", "LIFEOS-094: not /decisions — that is the knowledge Decision record type"] },
  ...
  { route: "/constitution/reflection", surface: "Constitution in Practice", purpose: "Adopted elements next to what Conqify has recorded.", primaryAction: "Change period", secondaryActions: ["Link something", "Why am I seeing this?"], emptyState: "instructional", loadingState: "skeleton", errorState: "boundary", mobile: "list", keyboard: "arrow nav", inspector: "n/a", onboardingDependency: false, notes: [] },
  { route: "/constitution/build", surface: "Constitution Builder", purpose: "A guided interview that proposes wording you may adopt.", primaryAction: "Next", secondaryActions: ["Back", "Skip", "Adopt", "Keep as draft", "Dismiss"], emptyState: "instructional", loadingState: "inline", errorState: "boundary", mobile: "single question", keyboard: "tab through", inspector: "n/a", onboardingDependency: false, notes: ["nothing is adopted without an explicit per-item click"] },
