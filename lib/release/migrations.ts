 ...
 *
 * Historical migrations are never modified. The current head is 0036
 * (`0036_action_due_date.sql`, the LIFEOS-053 minimal time model). A
 * demonstrated release-blocking database defect would add exactly one
 * narrowly-scoped `0037_v1_release_fix.sql` beyond it.
 */
...
export const MIGRATION_CHECKPOINTS: readonly MigrationCheckpoint[] = [
  ...
  { id: "current", label: "Current production head", throughVersion: 36 },
];
 ...
 */
export const ALLOWED_RELEASE_FIX_MIGRATION = "0037_v1_release_fix.sql";
