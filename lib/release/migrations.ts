 ...
 * database defect would add exactly one narrowly-scoped `0032_v1_release_fix.sql`.
 */
...
export const MIGRATION_CHECKPOINTS: readonly MigrationCheckpoint[] = [
  ...
  { id: "current", label: "Current production head", throughVersion: 31 },
];
 ...
 */
export const ALLOWED_RELEASE_FIX_MIGRATION = "0032_v1_release_fix.sql";
