...
const DATA_BEARING = new Set<string>([
  ...
  "/plan", "/focus", "/daily", "/reading", "/document", "/world", "/beliefs", "/constitution",
...
export function validateRoutes(): RouteAuditReport {
  ...
  const helpExempt = new Set(["/document", "/world", "/beliefs", "/constitution", "/research", "/search", "/workspaces", "inspector"]);
